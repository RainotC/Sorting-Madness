...
public class MergeSortTest {
    ...
    void correctLimitsSort() {
        ...
        mergeSort.sort(arr, 1000, 1000000000);
    ...
    void correctNoLimitsSortStrings() {
        ...
        mergeSort.sort(arr, 0, 0); // Sort the array using your custom mergeSort method
